...
const Typography: FC<TypographyProps> = ({
  ...
  const baseFontSize = baseFontSizes[type];

  const fontSize = `calc(${fontSizeVw * baseFontSize * sizeMultiplier}vw + ${
    fontSizeVh * baseFontSize * sizeMultiplier
  }vh + ${fontSizeVmin * baseFontSize * sizeMultiplier}vmin)`;
  ...
  const baseLineHeight = lineHeightMultipliers[type];
